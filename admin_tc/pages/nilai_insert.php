...
<p class="backk"><a href="index.php?page=nilai&pages=nilai_view" class="back"></a></p>
<div id="form">
<ul>
<form method="post" action="index.php?page=nilai_insert_proses">
<?php
...
?>
    ...
    <select name="pelatihan" class="option" onchange="location.href=('index.php?page=nilai&pages=nilai_insert&pelatihan='+this.value)">
    ...
    <select name="judul_training" class="option" onchange="self.location=('index.php?page=nilai&pages=nilai_insert&pelatihan=<?php echo $getpelatihan; ?>&judul_training='+this.value)">
    <option value=""></option>
    <?php
    ...
    <li>
    <label>Kelas</label>
    <select name="kelas" class="option" onchange="location.href=('index.php?page=nilai&pages=nilai_insert&pelatihan=<?php echo $getpelatihan; ?>&judul_training=<?php echo $judul_training; ?>&kelas='+this.value)">
    <option value=""></option>
    <?php
...
{ 
		...
		<td align="center">
		<input type='radio' name='status[<?php echo $view['no_peserta']; ?>]' value='lulus' checked="checked" class="radio" required='required'/>Lulus 
		<input type='radio' name='status[<?php echo $view['no_peserta']; ?>]' value='remidi' class="radio" required='required'/>Remidi
		</td>
		</tr>
		<?php
		@$i++;
