...
$sql1=mysql_query("select sum(discount) as discount from tb_daftar_peserta,tb_group_kuitansi where tb_daftar_peserta.no_peserta=tb_group_kuitansi.no_peserta and tb_group_kuitansi.no_group_kuitansi='$no_kuitansi' group by tb_group_kuitansi.no_peserta ");$nama=mysql_fetch_array($sql1);
$no_peserta=$nama['0'];
...
<div id="no_k">
Kwitansi No. : <?php echo $no_kuitansi ?> 
<?php
