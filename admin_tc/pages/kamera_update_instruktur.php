...
<div id="content">
	...
	<script language="JavaScript">
		webcam.set_api_url( 'config/test_update_instruktur.php?id=<?php echo $var ?>' );
	...
	<script language="JavaScript">
		...
		function do_upload() {
			...
			webcam.upload();
			location.href=('index.php?page=instruktur_update_kamera&editinstruktur=<?php echo $var; ?>&image=<?php echo $var; ?>');
