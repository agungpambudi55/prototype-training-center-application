...
<div id="content">
	...
	<script language="JavaScript">
		webcam.set_api_url( 'config/test_update.php?id=<?php echo $var ?>' );
	...
	<script language="JavaScript">
		...
		function do_upload() {
			...
			webcam.upload();
			location.href=('index.php?page=peserta&pages=daftar_peserta_kamera_update&editpeserta=<?php echo $var; ?>&image=<?php echo $var; ?>');
