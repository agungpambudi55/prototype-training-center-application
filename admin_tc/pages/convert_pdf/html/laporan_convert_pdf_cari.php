...
?>
    ...
    <p class="judul" align="left">Laporan Jadwal, Peserta dan Pendapatan Bulan <?php echo $bulan1 ." ". $tahun ;?><br />WEBSITE <?php echo strtoupper($arr_aks['keterangan']); ?></p>
 </th>
  </tr>
<hr style="color:#666" />
<br />
...
?>
<?php
echo "Laporan jadwal bulan ".$bulan1." ".$tahun."". " : <br><br>";
?>
...
<br>
<?php
echo "Laporan peserta bulan ".$bulan1." ".$tahun."". " :<br><br>";
?>
...
<br>
<?php
echo "Total Pendapatan bulan ".$bulan1." ".$tahun."". " : ";
