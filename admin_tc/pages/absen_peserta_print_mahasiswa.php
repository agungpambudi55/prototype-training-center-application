...
?>
<style>
#print{ background:url(../style/images/printer.png) no-repeat 1px 0px ; width:0; padding:14px; border:0px solid gray; position:fixed; top:15px; right:50%; cursor:pointer;}
...
if(!$row){
	...
	echo "<script>alert ('jenis peserta mahasiswa tidak ada');location.href = ('javascript:self.history.back();');</script>";
	}else{
@$pelatihan=$row['42'];
...
?>
<title>Print Absen Mahasiswa</title><br>
<p style="margin:0; padding:0; border:0px solid gray; padding:0px 0px 10px 10px; font-size:20px; color:#C33">
...
<table border="1"  cellpadding="0" cellspacing="0" style="margin:auto; font-size:15px; font-family:'Times New Roman';" width="100%">
  
  <tr>
    <td align="center"><strong>No</strong></td>
    <td align="center"><strong>Instruktur</strong></td>
    <td colspan="3" align="center"><strong>Materi</strong></td>
    <td align="center">T<strong>anda Tangan</strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="6"><strong>Nama Peserta Pelatihan :</strong></td>
  </tr>
  ...
  <tr bgcolor="#999999">
    ...
    <td align="center"><strong>NRP</strong></td>
    <td align="center"><strong>Tanda Tangan</strong></td>
  </tr>
  <?php 
$peserta=mysql_query("SELECT tb_daftar_peserta.nama, tb_daftar_peserta.email, tb_daftar_peserta.nrp
