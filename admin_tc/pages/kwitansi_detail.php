...
@$tmp=mysql_fetch_array(select_where(tb_jenis_peserta,id_jenis_peserta,@$view['id_jenis_peserta'])); 
?>

<p style="margin:0; border:0px solid gray; padding:0px 5px 10px 5px;">
<a href="index.php?page=peserta&pages=kwitansi" class="back"></a>
<a href="pages/kwitansi_bay_kui.php?i=<?php echo $no_kuitansi; ?>" target="_new"><img src="style/images/printer.png" style="float:right; cursor:pointer;"></a>
<p class="backk"></p>
</p>
<div style="font-size:16px; font-weight:bold; margin-top:-30px;">Detail Kwitansi</div>
<div id="kwitansi_det">
<ul>
	<li>Nama<p style="margin:-18px 0px 0px 125px; padding:0; border:0px solid gray"><b>:</b>&nbsp; <?php echo $nama['nama'];  ?></p></li>
	<li>Kode Kwitansi<p style="margin:-18px 0px 0px 125px; padding:0; border:0px solid gray"><b>:</b>&nbsp;  <?php echo $nama['2']; ?></p></li>
    <li>Jenis Peserta<p style="margin:-18px 0px 0px 125px; padding:0; border:0px solid gray"><b>:</b>&nbsp; <?php echo $tmp['jenis_peserta'];?></p></li>
    <li>Judul Pelatihan
	...
	echo "
    	<li style='border:0px solid gray; height:20px; padding:3px 0px'>$r[judul_training]
    ...
    <?php $jumlah = number_format($jumlah['biaya'],0,'','.');?>
    Rp. <?php echo $jumlah  ?>,00
    </p>
    </p>
    <?php
...
AND tb_kuitansi.no_kuitansi = '$no_kuitansi'");
    ...
    <div style="float:left; margin-left:565px; margin-top:0px; font-weight:bold"><?php echo "Rp. ".number_format($kueri,0,'','.').",00"; ?></div>
    </div>
