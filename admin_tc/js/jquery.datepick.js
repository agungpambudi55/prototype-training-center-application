...
function Datepicker() {
	this._defaults = {
		...
		showSpeed: 0, // Duration of display/closure
	...
	this.regional[''] = { // US/English
		...
		prevStatus: 'Bulan sebelumnya', // Status text for the previous month command
		prevJumpText: '&lt;&lt;', // Text for the previous year command
		prevJumpStatus: 'Show the previous year', // Status text for the previous year command
		nextText: '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', // Text for the next month command
		nextStatus: 'Bulan selanjutnya', // Status text for the next month command
		nextJumpText: '&gt;&gt;', // Text for the next year command
		nextJumpStatus: 'Show the next year', // Status text for the next year command
		currentText: 'Current', // Text for the current month command
		currentStatus: 'Show the current month', // Status text for the current month command
		todayText: 'HARI INI', // Text for the today's month command
		todayStatus: 'Hari ini', // Status text for the today's month command
		clearText: 'Hapus', // Text for the clear command
		clearStatus: 'Hapus', // Status text for the clear command
		closeText: 'Tutup', // Text for the close command
		closeStatus: 'Tutup', // Status text for the close command
		yearStatus: 'Ganti tahun', // Status text for year selection
		monthStatus: 'Ganti bulan', // Status text for month selection
		weekText: 'Wk', // Text for week of the year column header
		weekStatus: 'Week of the year', // Status text for week of the year column header
		dayStatus: 'Pilih DD, d M yyyy', // Status text for selectable days
		defaultStatus: 'Pilih tanggal', // Status text shown by default
